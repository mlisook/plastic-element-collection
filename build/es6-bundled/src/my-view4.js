define(["meta","./my-app.js"],function(meta,_myApp){"use strict";meta=babelHelpers.interopRequireWildcard(meta);const bundledImportMeta=babelHelpers.objectSpread({},meta,{url:new URL("../node_modules/plastic-resize-aware/plastic-element-query.js",meta.url).href});class PlasticElementQuery extends _myApp.PolymerElement{static get template(){return _myApp.html`
        <style>
          :host {
            display: none;
          }
