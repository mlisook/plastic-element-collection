...
<h3>Demo</h3>
      <h4>Often used as a container for images or videos</h4>
        ...
        <plastic-aspect-ratio style="width:60%;" aspect-width="4" aspect-height="3">
          ...
          <div id="sources"></div>
    `}static get properties(){return{_locationMarkers:{type:Array,value:function(){return[]}}}}static get importMeta(){return import.meta}connectedCallback(){super.connectedCallback();setTimeout(()=>{this._showSource()},1e3)}_showSource(){const mapMarkup=hljs.highlight("xml",`
   ...
   */
    ...
    <pre><code class="javascript">${jsCode.value}</code></pre>`}}window.customElements.define("my-view1",MyView1);export{ironJsonpLibrary as $ironJsonpLibrary,IronJsonpLibraryBehavior};